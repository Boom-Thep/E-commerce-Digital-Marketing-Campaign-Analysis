...
--3)Campaign Category Effectiveness: Determine the most effective campaign types (social, banner, influencer, search).
----Calculate total revenue generated, ROMI, Cost Per Click (CPC), Cost Per Lead (CPL), Customer Acquisition Cost (CAC), and Gross Profit for each campaign type.
